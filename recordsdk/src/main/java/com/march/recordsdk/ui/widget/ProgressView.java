...
public class ProgressView extends View {
    ...
    private void init() {
        ...
        setBackgroundColor(RecordCommonHelper.getColor(getContext(), R.color.camera_bg));

        mProgressPaint.setColor(RecordCommonHelper.getColor(getContext(), R.color.title_background_color));
        mProgressPaint.setStyle(Paint.Style.FILL);

        mActivePaint.setColor(RecordCommonHelper.getColor(getContext(), R.color.white));
        mActivePaint.setStyle(Paint.Style.FILL);

        mPausePaint.setColor(RecordCommonHelper.getColor(getContext(), R.color.camera_progress_split));
        mPausePaint.setStyle(Paint.Style.FILL);

        mRemovePaint.setColor(RecordCommonHelper.getColor(getContext(), R.color.camera_progress_delete));
        mRemovePaint.setStyle(Paint.Style.FILL);

        mThreePaint.setColor(RecordCommonHelper.getColor(getContext(), R.color.camera_progress_three));
        mThreePaint.setStyle(Paint.Style.FILL);

        mOverflowPaint.setColor(RecordCommonHelper.getColor(getContext(), R.color.camera_progress_overflow));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mMediaObject != null && mMediaObject.getMediaParts() != null) {
            ...
            left = right = 0;
            Iterator<MediaObject.MediaPart> iterator = mMediaObject.getMediaParts().iterator();
