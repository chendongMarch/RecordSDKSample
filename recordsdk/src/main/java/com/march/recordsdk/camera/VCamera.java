...
public class VCamera {
     ...
     * 初始化SDK
     *
     * @param context //	 * @param applicationId
     *                //	 * @param clientKey
     */
    public static void initialize(Context context) {
        ...
        //初始化底层库
        UtilityAdapter.FFmpegInit(context, String.format(Locale.CHINA
                , "versionName=%s&versionCode=%d&sdkVersion=%s&android=%s&device=%s"
                , mAppVersionName, mAppVersionCode, VCAMERA_SDK_VERSION
                , DeviceUtils.getReleaseVersion(), DeviceUtils.getDeviceModel()));
    }
